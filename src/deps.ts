...
export { Application, Router, Status, send } from "https://deno.land/x/oak@v9.0.1/mod.ts";
export { cyan, gray, red, yellow } from "https://deno.land/std@0.108.0/fmt/colors.ts";
